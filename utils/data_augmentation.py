...
class ImageGenerator(object):
    ...
    def _do_random_crop(self, image_array):
        ...
        current implementation does not transform bounding boxes"""
        ...
        image_channel = [ndi.interpolation.affine_transform(image_channel, crop_matrix, offset=offset, order=0, mode='nearest', cval=0.0) for image_channel in image_array]
